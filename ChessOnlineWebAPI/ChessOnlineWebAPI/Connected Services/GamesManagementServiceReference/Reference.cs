...
namespace ChessOnlineWebAPI.GamesManagementServiceReference {
    ...
    public partial class Game : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private ChessOnlineWebAPI.GamesManagementServiceReference.Game.Player PlayedAsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public ChessOnlineWebAPI.GamesManagementServiceReference.Game.Player PlayedAs {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="GamesManagementServiceReference.IGamesManagementService", CallbackContract=typeof(ChessOnlineWebAPI.GamesManagementServiceReference.IGamesManagementServiceCallback))]
    public interface IGamesManagementService {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(ChessOnlineWebAPI.GamesManagementServiceReference.GamesManagementFault), Action="http://tempuri.org/IGamesManagementService/SaveGameGamesManagementFaultFault", Name="GamesManagementFault", Namespace="http://schemas.datacontract.org/2004/07/GamesManagementService")]
        void SaveGame(ChessOnlineWebAPI.GamesManagementServiceReference.Game game, string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGamesManagementService/SaveGame", ReplyAction="http://tempuri.org/IGamesManagementService/SaveGameResponse")]
        System.Threading.Tasks.Task SaveGameAsync(ChessOnlineWebAPI.GamesManagementServiceReference.Game game, string token);
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(ChessOnlineWebAPI.GamesManagementServiceReference.GamesManagementFault), Action="http://tempuri.org/IGamesManagementService/GetAllSavedGamesGamesManagementFaultFa" +
            "ult", Name="GamesManagementFault", Namespace="http://schemas.datacontract.org/2004/07/GamesManagementService")]
        ChessOnlineWebAPI.GamesManagementServiceReference.Game[] GetAllSavedGames(string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGamesManagementService/GetAllSavedGames", ReplyAction="http://tempuri.org/IGamesManagementService/GetAllSavedGamesResponse")]
        System.Threading.Tasks.Task<ChessOnlineWebAPI.GamesManagementServiceReference.Game[]> GetAllSavedGamesAsync(string token);
        ...
        void DeleteGame(ChessOnlineWebAPI.GamesManagementServiceReference.Game game, string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGamesManagementService/DeleteGame", ReplyAction="http://tempuri.org/IGamesManagementService/DeleteGameResponse")]
        System.Threading.Tasks.Task DeleteGameAsync(ChessOnlineWebAPI.GamesManagementServiceReference.Game game, string token);
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(ChessOnlineWebAPI.GamesManagementServiceReference.GamesManagementFault), Action="http://tempuri.org/IGamesManagementService/FindMatchGamesManagementFaultFault", Name="GamesManagementFault", Namespace="http://schemas.datacontract.org/2004/07/GamesManagementService")]
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(ChessOnlineWebAPI.GamesManagementServiceReference.GamesManagementFault), Action="http://tempuri.org/IGamesManagementService/ManageActiveGameGamesManagementFaultFa" +
            "ult", Name="GamesManagementFault", Namespace="http://schemas.datacontract.org/2004/07/GamesManagementService")]
    ...
    public interface IGamesManagementServiceCallback {
        ...
        string StartingGame(ChessOnlineWebAPI.GamesManagementServiceReference.Game.Player playing_as);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IGamesManagementServiceChannel : ChessOnlineWebAPI.GamesManagementServiceReference.IGamesManagementService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class GamesManagementServiceClient : System.ServiceModel.DuplexClientBase<ChessOnlineWebAPI.GamesManagementServiceReference.IGamesManagementService>, ChessOnlineWebAPI.GamesManagementServiceReference.IGamesManagementService {
        ...
        public void SaveGame(ChessOnlineWebAPI.GamesManagementServiceReference.Game game, string token) {
            base.Channel.SaveGame(game, token);
        }
        
        public System.Threading.Tasks.Task SaveGameAsync(ChessOnlineWebAPI.GamesManagementServiceReference.Game game, string token) {
            return base.Channel.SaveGameAsync(game, token);
        }
        
        public ChessOnlineWebAPI.GamesManagementServiceReference.Game[] GetAllSavedGames(string token) {
            return base.Channel.GetAllSavedGames(token);
        }
        
        public System.Threading.Tasks.Task<ChessOnlineWebAPI.GamesManagementServiceReference.Game[]> GetAllSavedGamesAsync(string token) {
            return base.Channel.GetAllSavedGamesAsync(token);
        }
        
        public void DeleteGame(ChessOnlineWebAPI.GamesManagementServiceReference.Game game, string token) {
            base.Channel.DeleteGame(game, token);
        }
        
        public System.Threading.Tasks.Task DeleteGameAsync(ChessOnlineWebAPI.GamesManagementServiceReference.Game game, string token) {
